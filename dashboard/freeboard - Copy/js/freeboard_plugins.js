...
function FreeboardModel(datasourcePlugins, widgetPlugins, freeboardUI)
{
	...
	//.create with data = pane
	this.createNewPane = function(pane)
	{
		var newPane = new PaneModel(self, widgetPlugins);
		newPane.deserialize(pane);
		self.panes.push(newPane);
	}
...
var freeboard = (function()
{
	...
	return {
		...
		{
			theFreeboardModel.createNewPane(pane)
			//theFreeboardModel.panes.push(pane);
		},
